...
class DirectoryTest extends TestCase
{
    ...
    public function testListAllRecursive(){
        ...
        $this->assertEquals($expected, $dir->recursive()->list());
    }
    ...
    public function testListOnlyDirsRecursive(){
        ...
        $this->assertEquals($expected, $dir->recursive()->list(Directory::LIST_DIR));
    }
    ...
    public function testListOnlyFilesRecursive(){
        ...
        $this->assertEquals($expected, $dir->recursive()->list(Directory::LIST_FILES));
    }
    
    public function testGetRecursiveDirectoryIterator()
    {
        $dir = new Directory(__DIR__);
        $this->assertInstanceOf(\RecursiveDirectoryIterator::class, $dir->recursive()->iterator());
    }
    ...
    public function testDeleteRecursive(){
        ...
        $this->assertEquals([], $dir->recursive()->list());
    }
